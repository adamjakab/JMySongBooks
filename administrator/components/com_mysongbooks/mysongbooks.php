...
if (!\JFactory::getUser()->authorise('core.manage', COMPONENT_ELEMENT_NAME_MYSONGBOOKS)) {
	\JFactory::getApplication()->enqueueMessage(JText::_('MYSONGBOOKS_NOT_AUTHORIZED'), 'error');
	return;
}

//create and init the app
$coreApp = new MySongBooks\Core\Application();
$coreApp->init("backend");
